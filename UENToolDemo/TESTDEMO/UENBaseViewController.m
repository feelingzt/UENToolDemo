//
//  UENBaseViewController.m
//  TESTDEMO
//
//  Created by 张涛 on 2020/11/5.
//

#import "UENBaseViewController.h"

@interface UENBaseViewController ()

@end

@implementation UENBaseViewController
...
- (CGFloat)getStatusRectAndNavRect{
    ...
    CGRect navRect = [[UINavigationController alloc] init].navigationBar.frame;
    //导航栏+状态栏的高度
